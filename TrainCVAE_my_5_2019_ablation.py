...
class SketchyData(object):
    ...
    def __init__(self, ablation_5_1, n_x=4096, n_y=4096, n_z=1024, n_d=2048):
...
class CVAE(object):
    ...
    def __init__(self, sketchy_data, ablation_5_2, max_epoch=25, batch_size=1024, summary_path="summary"):
    ...
    def test_simple(self, epoch):
        ...
        print("predict time is {}, retrail time is {}, all time is {}, av time is {}".format(
            predict_time, retrial_time, predict_time + retrial_time, (predict_time + retrial_time) / predict_num))
    ...
    def test(self, epoch):
        ...
        # for neigh_num in [100, 200, predict_num]:
            # P1空间计算
            Tools.print()
            start_time = time.time()
            ...
            Tools.print("{} {} {} {} {}".format(neigh_num, "P1空间计算",
                                                precision_neigh_num, m_ap, time.time() - start_time))
            Tools.print("{} predict time is {}, retrail time is {}, all time is {}, av time is {}".format(
                neigh_num, predict_time, retrial_time,
                predict_time + retrial_time, (predict_time + retrial_time) / predict_num))
...
if __name__ == '__main__':
    ...
    for n_d in ablation_n_d:
        Tools.print("")
        name = "triplet_2019_{}_{}_{}_{}_{}".format(ablation_5_1["vgg_sketch"], ablation_5_1["model_sketch"],
                                                    ablation_5_2["triplet_1"], ablation_5_2["triplet_2"], n_d)
        Tools.print("name = {}".format(name))
        Tools.print("ablation_5_1 = [vgg_sketch: {}, model_sketch: {}]".format(
            ablation_5_1["vgg_sketch"], ablation_5_1["model_sketch"]))
        Tools.print("ablation_5_2 = [triplet_1: {}, triplet_2: {}]".format(
            ablation_5_2["triplet_1"], ablation_5_2["triplet_2"]))
        ...
        cvae = CVAE(sketchy_data=sketchy_data, ablation_5_2=ablation_5_2, max_epoch=20,
                    batch_size=1024, summary_path="model_final/{}/summary".format(name))

        cvae.run(model_1_file="model_final/{}/model_1.h5".format(name),
                 model_2_file="model_final/{}/model_2.h5".format(name), load_weights=False)
